...
public class BatteryLightSettings extends SettingsPreferenceFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        boolean isLightEnabled = Settings.System.getIntForUser(resolver,
                Settings.System.BATTERY_LIGHT_ENABLED, isBatteryLightEnabled(context) ? 1 : 0, UserHandle.USER_CURRENT) != 0;
        mLightEnabledPref.setChecked(isLightEnabled);

        boolean isLightFullChargeDisabled = Settings.System.getIntForUser(resolver,
                Settings.System.BATTERY_LIGHT_FULL_CHARGE_DISABLED, isBatteryLightFullChargeDisabled(context) ? 1 : 0, UserHandle.USER_CURRENT) != 0;
        ...
        if (!pulsatingLed || segmentedBatteryLed) {
            ...
            boolean isPulseEnabled = Settings.System.getIntForUser(resolver,
                    Settings.System.BATTERY_LIGHT_PULSE, isBatteryLightPulseEnabled(context) ? 1 : 0, UserHandle.USER_CURRENT) != 0;
    ...
    protected void resetColors() {
        ...
        Settings.System.putIntForUser(resolver, Settings.System.BATTERY_LIGHT_LOW_COLOR,
                mDefaultLowColor, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.BATTERY_LIGHT_MEDIUM_COLOR,
