...
import com.alpha.settings.preferences.PackageListAdapter;
import com.alpha.settings.preferences.PackageListAdapter.PackageItem;
...
public class NotificationLightSettings extends SettingsPreferenceFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (!mMultiColorLed) {
            ...
            //watch(Settings.System.getUriFor(Settings.System.NOTIFICATION_LIGHT_COLOR_AUTO));
        }
    ...
    private void refreshDefault() {
        ...
        int color = Settings.System.getIntForUser(resolver,
                Settings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, mDefaultColor, UserHandle.USER_CURRENT);
        int timeOn = Settings.System.getIntForUser(resolver,
                Settings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, mDefaultLedOn, UserHandle.USER_CURRENT);
        int timeOff = Settings.System.getIntForUser(resolver,
                Settings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, mDefaultLedOff, UserHandle.USER_CURRENT);

        mDefaultPref.setAllValues(color, timeOn, timeOff);

        // Get Missed call and Voicemail values
        if (mCallPref != null) {
            int callColor = Settings.System.getIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR, mDefaultColor, UserHandle.USER_CURRENT);
            int callTimeOn = Settings.System.getIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, mDefaultLedOn, UserHandle.USER_CURRENT);
            int callTimeOff = Settings.System.getIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, mDefaultLedOff, UserHandle.USER_CURRENT);

            mCallPref.setAllValues(callColor, callTimeOn, callTimeOff);
        }

        if (mVoicemailPref != null) {
            int vmailColor = Settings.System.getIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, mDefaultColor, UserHandle.USER_CURRENT);
            int vmailTimeOn = Settings.System.getIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, mDefaultLedOn, UserHandle.USER_CURRENT);
            int vmailTimeOff = Settings.System.getIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF, mDefaultLedOff, UserHandle.USER_CURRENT);
    ...
    private int getInitialColorForPackage(String packageName) {
        boolean autoColor = Settings.System.getIntForUser(getActivity().getContentResolver(),
                Settings.System.NOTIFICATION_LIGHT_COLOR_AUTO, mMultiColorLed ? 1 : 0, UserHandle.USER_CURRENT) == 1;
    ...
    protected void updateValues(String packageName, Integer color, Integer timeon, Integer timeoff) {
        ...
        if (packageName.equals(DEFAULT_PREF)) {
            Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, color, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, timeon, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, timeoff, UserHandle.USER_CURRENT);
            refreshDefault();
            return;
        } else if (packageName.equals(MISSED_CALL_PREF)) {
            Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR, color, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, timeon, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, timeoff, UserHandle.USER_CURRENT);
            refreshDefault();
            return;
        } else if (packageName.equals(VOICEMAIL_PREF)) {
            Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, color, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, timeon, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF, timeoff, UserHandle.USER_CURRENT);
            refreshDefault();
            return;
        }
    ...
    protected void resetColors() {
        ...
        Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, mDefaultColor, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR, mDefaultColor, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, mDefaultColor, UserHandle.USER_CURRENT);
