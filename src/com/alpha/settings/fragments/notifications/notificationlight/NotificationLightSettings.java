...
public class NotificationLightSettings extends SettingsPreferenceFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (!mMultiColorLed) {
            ...
            //watch(Settings.System.getUriFor(NOTIFICATION_LIGHT_COLOR_AUTO));
        }
    ...
    protected void updateValues(String packageName, Integer color, Integer timeon,
        ...
        if (packageName.equals(DEFAULT_PREF)) {
            Settings.System.putIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, color, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, timeon, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, timeoff, UserHandle.USER_CURRENT);
            refreshDefault();
            return;
        } else if (packageName.equals(MISSED_CALL_PREF)) {
            Settings.System.putIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR, color, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, timeon, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, timeoff, UserHandle.USER_CURRENT);
            refreshDefault();
            return;
        } else if (packageName.equals(VOICEMAIL_PREF)) {
            Settings.System.putIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, color, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, timeon, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(resolver,
                    Settings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF, timeoff, UserHandle.USER_CURRENT);
            refreshDefault();
            return;
        }
