...
import com.alpha.settings.fragments.*
...
class AlphaSettings : SettingsPreferenceFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requireActivity().setTitle(R.string.alpha_settings_title)
    }
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.alpha_settings, container, false)
    ...
    override fun getMetricsCategory(): Int =
        MetricsProto.MetricsEvent.ALPHA
